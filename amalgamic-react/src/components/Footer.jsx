    ...
    <footer className="py-24 bg-bg border-t border-border px-8">
      ...
      <div className="max-w-[1200px] mx-auto mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-6 text-[13px] font-bold text-muted">
          <a href="https://www.linkedin.com/company/amalgamic-io/" target="_blank" className="hover:text-brand transition-colors">LinkedIn</a>
          <a href="https://x.com/amalgamic_io" target="_blank" className="hover:text-brand transition-colors">Twitter</a>
          <a href="mailto:support@amalgamic.io" target="_blank" className="hover:text-brand transition-colors">Email</a>
        </div>
      </div>
    </footer>
  );
