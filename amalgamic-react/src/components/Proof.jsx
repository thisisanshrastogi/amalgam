          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[600px]">
              ...
              <tbody className="divide-y divide-border">
                <tr className="proof-row opacity-0 hover:bg-surface/30 transition-colors">
                  <td className="px-8 py-6 text-[15px] text-brand">Subscription active 14 months after cancellation</td>
                  <td className="px-8 py-6 font-serif text-xl font-bold text-highlight">$312.00</td>
                ...
                <tr className="proof-row opacity-0 hover:bg-surface/30 transition-colors">
                  ...
                  <td className="px-8 py-6 font-serif text-xl font-bold text-highlight">$45.00</td>
                ...
                <tr className="proof-row opacity-0 hover:bg-surface/30 transition-colors">
                  ...
                  <td className="px-8 py-6 font-serif text-xl font-bold text-highlight">$200.00</td>
                ...
                <tr className="proof-row opacity-0 hover:bg-surface/30 transition-colors">
                  ...
                  <td className="px-8 py-6 font-serif text-xl font-bold text-highlight">$50.00</td>
                  <td className="px-8 py-6 text-[15px] text-muted">Same day</td>
                </tr>
                <tr className="proof-row opacity-0 hover:bg-surface/30 transition-colors">
                  <td className="px-8 py-6 text-[15px] text-brand">Duplicate charge, same merchant, same day</td>
                  <td className="px-8 py-6 font-serif text-xl font-bold text-highlight">$89.00</td>
