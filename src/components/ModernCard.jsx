...
export const ModernCard = ({
    ...
    <div className="relative" style={{ transformStyle: 'preserve-3d' }}>
        ...
        <div
            className={face === "#14382F" ? `relative w-[280px] h-[176px] sm:w-[380px] sm:h-[240px] rounded-[14px]
                 p-5 sm:p-6 flex flex-col overflow-hidden` : `relative w-[280px] h-[176px]  sm:w-[360px] sm:h-[228px] rounded-[14px]
