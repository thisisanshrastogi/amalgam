      ...
      <div className="relative z-10 flex flex-col items-center justify-between w-full gap-12 mx-auto max-w-[1200px] lg:flex-row lg:gap-8">
        ...
        <div className="max-w-xl pt-12 shrink-0 md:pt-0">
          ...
          <p data-hero-reveal className="hero-p mb-10 text-lg leading-relaxed text-brand/70">
            See every card. Pay all bills. Track rewards. Stop extra charges that you shouldn't be paying. Amalgamic gives you control of your credit cards unlike ever before.
          </p>
        ...
        <div
          className="relative hidden lg:block w-full mt-16 h-[500px] lg:mt-0 lg:h-[600px] lg:w-1/2 translate-x-8 lg:translate-x-[50px]"
