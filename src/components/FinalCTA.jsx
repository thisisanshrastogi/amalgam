  ...
  return (
    <section ref={root} className="py-40 bg-accent text-center relative overflow-hidden text-bg">
      <div className="max-w-[800px] mx-auto px-8 relative z-10">
        <h2 className="cta-heading opacity-0 font-serif text-6xl leading-tight mb-10 text-bg">Never miss a bill again.</h2>
        ...
        <div className="cta-trust opacity-0 flex flex-wrap items-center justify-center gap-6 text-[10px] font-bold uppercase tracking-widest text-bg/60">
